<template>
    <div class="schema">
        <svg width="2046" height="941" viewBox="0 0 2046 941" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="sustaperf">
                ...
                <g id="Mask Group">
                    ...
                    <g mask="url(#mask0)">
                        <rect id="path_1_bg" x="883" y="297" width="1124" height="574" fill="#657DA2" />
                ...
                <g id="path_2">
                    ...
                    <g mask="url(#mask1)">
                        <rect id="path_2_bg" x="43" y="85" width="1124" height="574" fill="#657DA2" />
